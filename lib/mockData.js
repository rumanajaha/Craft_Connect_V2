// Mock database data for the CraftConnect dashboard flows
// Fields match standard schema designs for easy backend migration later
...
export const MOCK_MESSAGES = [
  ...
  },
  {
    ...
    lastMessageTime: "2 hours ago",
    unread: true,
    isCreatorThread: true, // distinguishing flag
    creatorName: "Sarah Indigo",
    creatorAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80",
    messages: [
      {
        id: "m-c-1",
        sender: "customer", // represents the creator in this context
...
export const MOCK_BRAND_MATCHES = [
  { ...MOCK_BRANDS[0], compatibility: 94 }, // Ochre Clay
  { ...MOCK_BRANDS[2], compatibility: 88 }, // Soren Objects
  { ...MOCK_BRANDS[4], compatibility: 85 }, // Sienna Botanicals
  { ...MOCK_BRANDS[1], compatibility: 79 }, // Gaea Weaves
  { ...MOCK_BRANDS[5], compatibility: 72 }, // Zephyr Glass
];
