...
export default function AuthLayout({ children }) {
  ...
  // Determine static image and alt text depending on active route
  const isSignup = pathname?.includes("signup");
  
  const bgImage = isSignup
    ? "https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=1200&auto=format&fit=crop&q=80" // Handcrafted ceramics - verified working
    : "https://images.unsplash.com/photo-1612196808214-b8e1d6145a8c?w=1200&auto=format&fit=crop&q=80"; // Pottery hands - verified working
  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center p-4 md:p-8 lg:p-12 bg-[#FAF7F0] overflow-hidden">
      ...
      {/* Decorative background blurs — soft, muted craft colors (sage & terracotta tones) */}
      ...
      {/* Single Unified Card (with auth-container to strip inner Card wrappers) */}
      <div className="auth-container bg-white w-full max-w-4xl rounded-3xl shadow-[0_16px_40px_rgba(43,43,43,0.06)] overflow-hidden grid grid-cols-1 md:grid-cols-12 border border-brand-border/40 z-10">
        ...
        <div className="col-span-1 md:col-span-7 flex flex-col justify-between p-6 sm:p-8">
          ...
          {/* Render children form (Card component gets style-stripped automatically) */}
          <div className="w-full">
            {children}
          </div>

          {/* Under-card simple terms link */}
        ...
        {/* Right column: Static craft image zone (~42%) */}
        <div className="relative h-[220px] md:h-auto w-full col-span-1 md:col-span-5 order-first md:order-last overflow-hidden">
          ...
          />
          {/* Minimal branding badge in corner of image */}
