...
function getPageTitle(pathname) {
  ...
  if (pathname?.startsWith("/customer/saved")) return "Saved Brands";
  ...
  if (pathname?.startsWith("/customer/brand")) return "Brand Profile";
  return "CraftConnect";
}
