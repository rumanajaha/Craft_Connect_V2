...
import { MessageCircle, CheckCircle, XCircle, Sparkles, Users, Package, TrendingUp, Lock, Loader2, User, Clock } from "lucide-react";
...
function formatDBNotification(notif) {
  ...
  const ColorMap = {
    ...
    pitch_response: "text-emerald-600",
